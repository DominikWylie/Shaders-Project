...
public:
	...
	* Contains default update/frame operations including calculating delta timeInput, calling handle input and starting UI rendering
	*/
	virtual bool frame();
...
protected:
	...
	Timer* timer;			///< Pointer to timer object (for delta timeInput and FPS)
