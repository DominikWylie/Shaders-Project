...
void Camera::moveForward()
{
	...
	// Update the forward movement based on the frame timeInput
	speed = frameTime * 5.f;
...
void Camera::moveBackward()
{
	...
	// Update the backward movement based on the frame timeInput
...
{
	// Update the upward movement based on the frame timeInput
	speed = frameTime * 5.f;// *0.5f;
...
{
	// Update the downward movement based on the frame timeInput
	speed = frameTime * 5.f;// *0.5f;
...
{
	// Update the left turn movement based on the frame timeInput 
...
{
	// Update the right turn movement based on the frame timeInput
	speed = frameTime * 25.0f;
...
void Camera::turnUp()
{
	// Update the upward rotation movement based on the frame timeInput
	speed = frameTime * 25.0f;
...
{
	// Update the downward rotation movement based on the frame timeInput
	speed = frameTime * 25.0f;
